/* ==========================================================================
   QIAGEN INVENTORY - ULTIMATE MASTER FIX (NO FEATURES REMOVED)
   - FIXED: Invalid Action (รองรับทั้ง addstock, deposit, depositstock)
   - FIXED: Staff Inventory Audit & Load Error
   - PRESERVED: Login Fix, Admin Modal, Withdraw, Return, Use, Search
   ========================================================================== */
